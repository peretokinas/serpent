  ...
  <div class="auth-modal__two auth-modal__reg-code">
    ...
    <form method="POST">
      <div class="code-input">
        <input name="f_code_1" type="text" maxlength="1" placeholder="0">
        <input name="f_code_2" type="text" maxlength="1"placeholder="0">
        <div class="code-input__delimiter">-</div>
        <input name="f_code_3" type="text" maxlength="1" placeholder="0">
        <input name="f_code_4" type="text" maxlength="1" placeholder="0">
      </div>
      <button class="btn btn-entry auth_btn_send_auth_code_action">Продолжить</button>
      <div class="code-timer code-timer-action" time-now="90">
