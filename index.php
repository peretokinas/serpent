    ...
    <div class="slider-index swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="slider-index__item" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/main/index-slide.jpg')">
                    <div class="slider-index__item__bg-tablet" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/main/bg-tablet.jpg')">
                        <div class="container">
                            <div class="slider-index__title">Российский бренд купальников и нижнего белья</div>
                            <a href="#" class="slider-index__description">Коллекция купальников Lady of Rings</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="product-slide">
                                <div class="product-slide__pic">
                                    ...
                                    <div class="product-slide__swiper swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-1.jpg" alt="">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-1.jpg" alt="">
                                            </div>
                                ...
                                <div class="product-slide__event">
                                    <div class="product-slide__color">
                                        <div class="product-slide__color-item">
                                            <input type="radio" name="color-1" checked>
                            ...
                            <div class="product-slide">
                                <div class="product-slide__pic">
                                    ...
                                    <div class="product-slide__swiper swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-2.jpg" alt="">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-2.jpg" alt="">
                                            </div>
                                ...
                                <div class="product-slide__event">
                                    <div class="product-slide__color">
                                        <div class="product-slide__color-item">
                                            <input type="radio" name="color-2" checked>
                                            <span class="product-slide__color-circle">
                                                <span style="background: #263740"></span>
                                            </span>
                                        </div>
                                        <div class="product-slide__color-item">
                                            <input type="radio" name="color-2">
                                            <span class="product-slide__color-circle">
                                                <span style="background: #E6B886"></span>
                                            </span>
                                        </div>
                            ...
                            <div class="product-slide">
                                <div class="product-slide__pic">
                                    ...
                                    <div class="product-slide__swiper swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-3.jpg" alt="">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-3.jpg" alt="">
                                            </div>
                                ...
                                <div class="product-slide__event">
                                    <div class="product-slide__color">
                                        <div class="product-slide__color-item">
                                            <input type="radio" name="color-3" checked>
                                            <span class="product-slide__color-circle">
                                                <span style="background: #263740"></span>
                                            </span>
                                        </div>
                            ...
                            <div class="product-slide">
                                <div class="product-slide__pic">
                                    ...
                                    <div class="product-slide__swiper swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-4.jpg" alt="">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-4.jpg" alt="">
                                            </div>
                                ...
                                <div class="product-slide__event">
                                    <div class="product-slide__color">
                                        <div class="product-slide__color-item">
                                            <input type="radio" name="color-4" checked>
                                            <span class="product-slide__color-circle">
                                                <span style="background: #263740"></span>
                                            </span>
                                        </div>
                                        <div class="product-slide__color-item">
                                            <input type="radio" name="color-4">
                                            <span class="product-slide__color-circle">
                                                <span style="background: #E6B886"></span>
                                            </span>
                                        </div>
                            ...
                            <div class="product-slide">
                                <div class="product-slide__pic">
                                    ...
                                    <div class="product-slide__swiper swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/main/product-1.jpg" alt="">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/product-1.jpg" alt="">
                                            </div>
        ...
        <div class="journal section">
            ...
            <div class="slider-container">
                ...
                <div class="journal-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="#" class="journal-slide">
                                <span class="journal-slide__pic">
                                    <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/journal-1.jpg" alt="">
                                </span>
                                <span class="journal-slide__flex">
                                    <span class="journal-slide__date">03.01.2022</span>
                                    <span class="journal-slide__tag">ПОЛЕЗНАЯ ИНФОРМАЦИЯ</span>
                                </span>
                                <span class="journal-slide__title">Какие купальники нравятся мужчинам</span>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="#" class="journal-slide">
                            <span class="journal-slide__pic">
                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/journal-2.jpg" alt="">
                            </span>
                                <span class="journal-slide__flex">
                                <span class="journal-slide__date">03.01.2022</span>
                                <span class="journal-slide__tag">ПОЛЕЗНАЯ ИНФОРМАЦИЯ</span>
                            </span>
                                <span class="journal-slide__title">Как выбрать спортивный бюстгальтер</span>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="#" class="journal-slide">
                            <span class="journal-slide__pic">
                                <img src="<?=SITE_TEMPLATE_PATH;?>/img/main/journal-3.jpg" alt="">
                            </span>
                                <span class="journal-slide__flex">
                                <span class="journal-slide__date">03.01.2022</span>
                                <span class="journal-slide__tag">ПОЛЕЗНАЯ ИНФОРМАЦИЯ</span>
