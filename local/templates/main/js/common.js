window.addEventListener('load', function (){
      ...
      let swiperProductPic = new Swiper(item, {
        ...
        on: {
          init: function (){
            ...
            var touch_event=item.getAttribute("touch-event");
            if (touch_event!="N") { 
  ...
  if(document.querySelector('.showroom-slider')){
    let swiperShowroom = new Swiper('.showroom-slider', {
      loop: true,
      navigation: {
        nextEl: document.querySelector('.showroom-slider__container').querySelector('.swiper-button-next'),
        prevEl: document.querySelector('.showroom-slider__container').querySelector('.swiper-button-prev'),
      },
      breakpoints: {
        320: {
          slidesPerView: 1,
  ...
  if(document.querySelector('.pay-way__item')){
    ...
    //Списание баллов в корзине, пока рубим
  ...
  if(document.querySelector('.filter-item')){
    document.querySelectorAll('.filter-item').forEach((item) => {
      ...
      document.querySelector('.filter-mobile').addEventListener('click', function (){
        ...
        $(".catalog-filter").css("z-index", "1000");
      })
      document.querySelector('.filter-close').addEventListener('click', function (){
        ...
        $(".catalog-filter").css("z-index", "999");
      })
    })
  }
  ...
  if(document.querySelector('.header-event__link-search')){
    document.querySelector('.header-event__link-search').addEventListener('click', function (e){
      ...
      if(document.querySelector('.search-modal').classList.contains('active')){
        ...
        $(".basket-top").removeClass("no-before");
      }else{
        document.querySelector('.search-modal').classList.add('active');
        $(".basket-top").addClass("no-before");
      }
    })
