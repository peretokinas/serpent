          ...
          <div class="product-slide">
              ...
              <div class="product-slide__color">
                <div class="product-slide__color-item">
                  ...
                  <span class="product-slide__color-circle">
                    <span style="background: <?php echo $arParams["SETT_COLOR_1"][$val["arProps"]["TSVET"]["VALUE"]];?>"></span>
                  </span>
                </div>
              </div>
            ...
            <div class="product-slide__info">
              <div class="product-slide__content">
                <a href="#" class="product-slide__title"><?php echo $val["arFields"]["NAME"];?></a>
                <div class="product-slide__price">
                  <div class="product-slide__new-price"><span><?php echo $val["OFFERS"][0]["arPrice"][$arParams["SETT_SHOP"]["BASE_PRICE_CODE"]]["PRICE"];?></span> ₽</div>
                </div>
              </div>
